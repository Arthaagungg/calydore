...
$pageTitle = 'Calydore | Sewa Hotel di Puncak – Nyaman & Mewah';
$description = "Temukan hotel terbaik di Puncak Cisarua, Bogor untuk pengalaman menginap yang nyaman dan menyenangkan. Nikmati fasilitas lengkap dengan pemandangan indah dan suasana sejuk di kawasan Puncak. Booking hotel terbaik Anda sekarang!";
$pageType = "hotel";
$pageURL = BASE_URL .
    '/page/hotel';
    ...
    <div class="tab-pane fade show active" id="villa_tab" role="tabpanel" aria-labelledby="villa-tabs">
        <div class="container mb-3">
            <div class="row row-cols-1 row-cols-md-2 g-4 mb-5" id="villa">
                <?php
                $allVillaIdsQuery = "SELECT id FROM hotel";
                ...
                shuffle($allVillaIds);
                $_SESSION['shuffled_hotel_ids'] = $allVillaIds;
                $initialIds = array_slice($allVillaIds, 0, 4);
                $_SESSION['shuffled_hotel_ids'] = array_slice($allVillaIds, 4);
                ...
                SELECT v.id, v.nama_hotel, v.deskripsi, v.harga_weekday, v.harga_weekend, 
                       ...
                       (SELECT COUNT(*) FROM hotel_features vf WHERE vf.hotel_id = v.id) AS feature_count
                FROM hotel v
            ...
            ";
                ...
                if ($result->num_rows > 0) {
                    $imageQuery = "SELECT hotel_id, file_name, file_path FROM hotel_images";
                    $imageResult = $conn->query($imageQuery);

                    $villaImages = [];
                    if ($imageResult->num_rows > 0) {
                        while ($imageRow = $imageResult->fetch_assoc()) {
                            $villaId = $imageRow['hotel_id'];
                    ...
                    <div class="sub-box-content">
                      ...
                      <p class="title">' . htmlspecialchars($villa['nama_hotel']) . '</p>
                    ...
                    <a href="' . BASE_URL . '/hotel/' . htmlspecialchars($villa['slug_hotel']) . '" class="btn-selengkapnya">Selengkapnya</a>
                  </div>
                </div>
              </div>';
                    }
                } else {
                    echo '<p>Data Hotel tidak tersedia.</p>';
                } ?>
            </div>
    ...
    <div class="tab-pane fade " id="terlaris_tab" role="tabpanel" aria-labelledby="terlaris-tabs">
        <div class="container mb-3">
            <div class="row row-cols-1 row-cols-md-2 g-4 mb-5" id="terlaris">
                ...
                $query = "SELECT * FROM hotel ORDER BY rating DESC LIMIT $limit OFFSET $offset";
                $result = $conn->query($query);
    ...
    <div class="tab-pane fade " id="harga-tab-up" role="tabpanel" aria-labelledby="hargaup-tabs">
        <div class="container mb-3">
            <div class="row row-cols-1 row-cols-md-2 g-4 mb-5" id="hargaup">
                ...
                $query = "SELECT * FROM hotel ORDER BY harga_weekday DESC LIMIT $limit OFFSET $offset";
                $result = $conn->query($query);
    ...
    <div class="tab-pane fade " id="harga-tab-down" role="tabpanel" aria-labelledby="hargadown-tabs">
        <div class="container mb-3">
            <div class="row row-cols-1 row-cols-md-2 g-4 mb-5" id="hargadown">
                ...
                $query = "SELECT * FROM hotel ORDER BY harga_weekday ASC LIMIT $limit OFFSET $offset";
                $result = $conn->query($query);
...
<script src="<?php echo BASE_URL; ?>/assets/js/load_hotel.js"></script>

<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "Hotel",
  "name": "Calydore | Sewa Hotel Nyaman & Mewah di Puncak",
  "url": "https://calydore.com/page/hotel",
  "logo": "<?php echo BASE_URL; ?>/assets/favico.ico",
  "description": "Sewa hotel di Puncak Cisarua dengan fasilitas mewah, lokasi strategis, dan harga terbaik.",
  "address": {
    "@type": "PostalAddress",
...
<?php
$ChatWa = "Permisi Kak? Mau tanya tentang Hotel di Calydore...";
