...
$stmt = $conn->prepare("SELECT * FROM villa_kamar");
$stmt->execute();
$result2 = $stmt->get_result();
$pageTitle = 'Calydore | Sewa Kamar Villa di Puncak – Nyaman & Private';
$description = "Temukan kamar villa yang nyaman di Puncak Cisarua, Bogor. Dapatkan pengalaman menginap yang mewah dan tenang di tengah alam, dengan layanan premium dan fasilitas lengkap untuk liburan tak terlupakan.";
    ...
    <div class="tab-pane fade show active" id="villa_tab" role="tabpanel" aria-labelledby="villa-tabs">
        <div class="container mb-3">
            <div class="row row-cols-1 row-cols-md-2 g-4 mb-5" id="villa">
                <?php
                $allVillaIdsQuery = "SELECT id FROM villa_kamar";
                ...
                shuffle($allVillaIds);
                $_SESSION['shuffled_villa_kamar_ids'] = $allVillaIds;
                $initialIds = array_slice($allVillaIds, 0, 4);
                $_SESSION['shuffled_villa_kamar_ids'] = array_slice($allVillaIds, 4);
                ...
                SELECT v.id, v.nama_villa_kamar, v.deskripsi, v.harga_weekday, v.harga_weekend, 
                       ...
                       (SELECT COUNT(*) FROM villa_kamar_features vf WHERE vf.villa_kamar_id = v.id) AS feature_count
                FROM villa_kamar v
            ...
            ";
                ...
                if ($result->num_rows > 0) {
                    $imageQuery = "SELECT villa_kamar_id, file_name, file_path FROM villa_kamar_images";
                    $imageResult = $conn->query($imageQuery);

                    $villaImages = [];
                    if ($imageResult->num_rows > 0) {
                        while ($imageRow = $imageResult->fetch_assoc()) {
                            $villaId = $imageRow['villa_kamar_id'];
                    ...
                    <div class="sub-box-content">
                      ...
                      <p class="title">' . htmlspecialchars($villa['nama_villa_kamar']) . '</p>
                    ...
                    <a href="' . BASE_URL . '/villa-kamar/' . htmlspecialchars($villa['slug_villa_kamar']) . '" class="btn-selengkapnya">Selengkapnya</a>
                    ...
                    echo '<p>data villa Kamar tidak tersedia.</p>';
                } ?>
            </div>
    ...
    <div class="tab-pane fade " id="terlaris_tab" role="tabpanel" aria-labelledby="terlaris-tabs">
        <div class="container mb-3">
            <div class="row row-cols-1 row-cols-md-2 g-4 mb-5" id="terlaris">
                ...
                $query = "SELECT * FROM villa_kamar ORDER BY rating DESC LIMIT $limit OFFSET $offset";
                $result = $conn->query($query);
    ...
    <div class="tab-pane fade " id="harga-tab-up" role="tabpanel" aria-labelledby="hargaup-tabs">
        <div class="container mb-3">
            <div class="row row-cols-1 row-cols-md-2 g-4 mb-5" id="hargaup">
                ...
                $query = "SELECT * FROM villa_kamar ORDER BY harga_weekday DESC LIMIT $limit OFFSET $offset";
                $result = $conn->query($query);
    ...
    <div class="tab-pane fade " id="harga-tab-down" role="tabpanel" aria-labelledby="hargadown-tabs">
        <div class="container mb-3">
            <div class="row row-cols-1 row-cols-md-2 g-4 mb-5" id="hargadown">
                ...
                $query = "SELECT * FROM villa_kamar ORDER BY harga_weekday ASC LIMIT $limit OFFSET $offset";
                $result = $conn->query($query);
...
<script src="<?php echo BASE_URL; ?>/assets/js/load_villa_kamar.js"></script>
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "LodgingBusiness",
  "name": "Calydore | Sewa Kamar Villa di Puncak – Private & Nyaman",
  "url": "https://calydore.com/page/villa-kamar",
  "logo": "<?php echo BASE_URL; ?>/assets/favico.ico",
  "description": "Sewa kamar villa di Puncak dengan suasana nyaman dan private. Cocok untuk liburan keluarga atau pasangan.",
  "address": {
    "@type": "PostalAddress",
...
<?php
$ChatWa = "Permisi Kak? Mau tanya tentang Villa Kamar di Calydore...";
