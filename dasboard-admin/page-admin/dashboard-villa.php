        ...
        <main class="p-3">
            <div class="container-fluid">
                <div class="mb-3 text-start">
                    <h3>Dashboard Villa</h3>
                    <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                        data-bs-target="#ModalVilla">Tambahkan villa <i class="uil uil-plus"></i></button>
                </div>
                <!-- Modal -->
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Tambahkan Villa</h5>
                            </div>
                            <div class="modal-body">
                                <form action="../proses/upload-data.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-section">
                                        ...
                                        <input type="text" class="form-control" id="nama_villa"
                                            name="categorys[nama_villa]" required>
                                    </div>
            ...
            <div class="row d-flex flex-wrap justify-content-center">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($villa = $result->fetch_assoc()) {
                        ...
                        $villa_id = $villa['id'];
                        $sql_images = "SELECT file_path, file_name FROM villa_images WHERE villa_id = ? LIMIT 1"; // Perbaikan query
                        $stmt_images = $conn->prepare($sql_images);
                        $stmt_images->bind_param("i", $villa_id);
                        $stmt_images->execute();
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card shadow-sm h-100">
                                <img src="<?php echo htmlspecialchars($first_image) . "?tr=w-640,h-360,q-80"; ?>"
                                    class="card-img-top" alt="<?php echo htmlspecialchars($villa['nama_villa']); ?>">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo htmlspecialchars($villa['nama_villa']); ?></h5>
                                    <p class="card-text">
