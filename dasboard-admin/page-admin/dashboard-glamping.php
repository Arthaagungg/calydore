            ...
            <main class="p-3">
                <div class="container-fluid">
                    <div class="mb-3 text-start">
                        <h3>Dashboard glamping</h3>
                        <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                            data-bs-target="#Modalglamping">Tambahkan glamping <i class="uil uil-plus"></i></button>
                    </div>
                    <!-- Modal -->
                    <div class="modal fade" id="Modalglamping" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Tambahkan glamping</h5>
                                </div>
                                <div class="modal-body">
                                    <form action="../proses/upload-data.php" method="POST"
                                        ...
                                        <input type="hidden" name="category" value="glamping">
                                        ...
                                        <div class="form-section">
                                            <label for="nama_glamping" class="form-label">Nama glamping</label>
                                            <input type="text" class="form-control" id="nama_glamping"
                                                name="categorys[nama_glamping]" required>
                                        </div>
                ...
                <div class="row d-flex flex-wrap justify-content-center">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($villa = $result->fetch_assoc()) {
                            ...
                            $glamping_id = $villa['id'];
                            $sql_images = "SELECT file_path, file_name FROM glamping_images WHERE glamping_id = ? LIMIT 1"; // Perbaikan query
                            $stmt_images = $conn->prepare($sql_images);
                            $stmt_images->bind_param("i", $glamping_id);
                            $stmt_images->execute();
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card shadow-sm h-100">
                                    <img src="<?php echo htmlspecialchars($first_image) . "?tr=w-640,h-360,q-80"; ?>"
                                        class="card-img-top" alt="<?php echo htmlspecialchars($villa['nama_glamping']); ?>">
                                    <div class="card-body">
                                        <h5 class="card-title"><?php echo htmlspecialchars($villa['nama_glamping']); ?></h5>
                                        <p class="card-text">
